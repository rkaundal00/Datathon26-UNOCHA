// UN M49 numeric code → ISO 3166-1 alpha-3 mapping.
// world-atlas countries-110m uses M49 numeric IDs on each Feature (e.g. "840" for USA).
// Kosovo is assigned the unofficial "XKX" code matching our backend convention.
...
const M49_TO_ISO3: Record<string, string> = {
  ...
  "242": "FJI", "246": "FIN", "248": "ALA", "250": "FRA", "254": "GUF",
  ...
  "410": "KOR", "412": "XKX", "414": "KWT", "417": "KGZ", "418": "LAO",
...
export function numericToIso3(id: string | number | null | undefined): string | null {
