...
export const COLUMN_META: Record<ColumnKey, ColumnMeta> = {
  ...
  gap_score: {
    ...
    popover: {
      ...
      whyItMatters: "Default ranking signal. A 50/50 blend of relative and absolute need, weighted by funding shortfall. Hover over any Gap score cell to see the decomposition.",
    },
    decomposable: true,
    thresholdable: false,
  },
