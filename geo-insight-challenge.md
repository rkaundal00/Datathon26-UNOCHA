...
Joe | Databricks — 10:51
We’d very much encourage you to use Databricks, if for no other reason than your technical judges for this challenge will be best equipped to evaluate a Databricks submission.
But come chat to me if you want to use something else @tree
Will be at the Databricks booth!
Mary — 11:06
Some general information about Humanitarian Financing and how it works:
https://www.unocha.org/we-fund
https://cbpf.data.unocha.org/

Examples of Humanitarian Financing Reviews and Infographics: 
https://reliefweb.int/updates?advanced-search=(S1503)_(T4589_T4597)_(F9)&search=annual+report
https://cbpf.data.unocha.org/cpf
https://reliefweb.int/updates?advanced-search=(S1503)_(T4589.T4597)_(F12570)

List of current Humanitarian Coordinators:
https://interagencystandingcommittee.org/sites/default/files/2026-02/Humanitarian%20Leadership%20Snapshot%20-%20February2026.pdf

Examples of Rapid Needs Assessments with unstructured/hard to access data:  https://reliefweb.int/updates?advanced-search=(DT4618)_(F5)&search=title%3A"rapid"

Common Operational Datasets that may be handy for baseline data:  https://data.humdata.org/dashboards/cod
Image
Joe | Databricks — 11:07
@Geun - Datathon Lead Can we get this pinned please? ^
Alex (Datathon - Software)
 a épinglé un message dans ce salon. Voir tous les messages épinglés. — 11:18
Alex (Datathon - Software) — 11:18
Pinned
Joe | Databricks — 11:18
Cheers Alex!
mic0 [NEXT],  — 12:48
@Joe | Databricks hey, where can we find you?
Joe | Databricks — 13:05
I’m not getting discord notifs for some reason, think my phone is struggling on the WiFi. I’ll try to check regularly but if you don’t get me here, I’m at the booth
Joe | Databricks — 14:48
Hey @here, just wanted to share that there has been some updates to the UNOCHA challenge doc, to remove some inaccuracies about the required submission and the judging process. The updated doc should be in the portal soon, but to be clear about the changes:

there is no automated analysis stage, every submission is reviewed by jury.
the document previously said all submissions MUST include a ranking and gap analysis. This is incorrect: that was meant to be an example of an approach you could take, not a requirement.

Let me know if you have any questions
TwilightJäger — 15:01
could you send the markdown doc here ? i think it is still not updated @Joe | Databricks 
Joe | Databricks — 15:14
...
Hackathon - Geo-Insight challenge.md
11 Ko
@TwilightJäger ^
﻿
**Geo-Insight: Which Crises Are Most Overlooked?**
...
* "Are there countries with active Humanitarian Response Plans where funding is absent or negligible?"  
...
* sector-level gaps within a crisis, for example health vs. food vs. shelter  
...
The core judging focus is the quality and defensibility of the gap ranking and the breadth of crisis types and queries your system can handle well.

**Data Provided**

You are provided with links to the following publicly available datasets as a starting point:

* Humanitarian Needs Overview data, which includes people in need figures by country and sector: https://data.humdata.org/dataset/global-hpc-hno  
* Humanitarian Response Plan data, which includes funding targets and plan status: https://data.humdata.org/dataset/humanitarian-response-plans  
* Global common operational datasets for population: https://data.humdata.org/dataset/cod-ps-global  
* Global requirements and funding data, which includes overall financial tracking: https://data.humdata.org/dataset/global-requirements-and-funding-data  
* CBPF Pooled Funds Data Hub, which includes country-based pooled fund allocations and visualizations: https://cbpf.data.unocha.org/
...
3. A demo, notebook, API, or dashboard that shows the full result flow  
4. A description of your gap-scoring and ranking logic  
...
* Think carefully about how to distinguish a crisis that has always been overlooked from one that was recently well-funded but has since deteriorated.
